...
try {
    $stmt = $conn->prepare("
        ...
        FROM usuarios u
        LEFT JOIN clientes c ON u.cpf = c.fk_cpf
...
<head>
    ...
    <style>
        /* Estilos do cabeçalho (já implementado em outros arquivos) */
        header {
...
<body>
    <!-- Cabeçalho implementado diretamente (como nos outros arquivos) -->
    <header>
        <!-- Logo -->
